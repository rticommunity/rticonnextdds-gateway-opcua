...
#ifndef RTI_OPCUA_PROCESSORS_OPCUAATTRIBUTESETPROCESSOR_HPP_
#define RTI_OPCUA_PROCESSORS_OPCUAATTRIBUTESETPROCESSOR_HPP_
 ...
 *
 */
class AttributeServiceSetProcessor
        : public rti::routing::processor::NoOpProcessor {
public:
    AttributeServiceSetProcessor();
...
private:
    void copy_related_sample_identity(
 ...
 *
 */
class AttributeServiceSetProcessorPlugin
        : public rti::routing::processor::ProcessorPlugin {
public:
    AttributeServiceSetProcessorPlugin();
...
#endif  // RTI_OPCUA_PROCESSORS_OPCUAATTRIBUTESETPROCESSOR_HPP_
